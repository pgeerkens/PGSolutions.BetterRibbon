...
Private Sub SimpleParseLinkTest()
    ...
    With New ExternalLinks
        ...
        MsgBox "Successfully parsed: " & vbNewLine & TestText & "as" & vbNewLine & vbNewLine & _
            "Path: " & .ItemByIndex(1).Path, _
            vbOKOnly, MethodName
    End With
...
Private Sub CellParseLinkTest()
    ...
    On Error GoTo EH
    With New ExternalLinks
        Dim TestText As String: TestText = _
        ...
        MsgBox "Successfully parsed: " & vbNewLine & TestText & vbNewLine & "as" & vbNewLine & vbNewLine & _
            "Path: " & .ItemByIndex(1).Path, _
            vbOKOnly, MethodName
    End With
