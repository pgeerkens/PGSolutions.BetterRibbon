...
Private Function ViewModelFor(ByVal Control As IRibbonControl _
    ...
    If Err.Number = 13 Then Set WkBk = ActiveWorkbook
    Err.Clear
    On Error GoTo EH
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Public Function GetEnabled(ByVal Control As IRibbonControl, ByRef Enabled)
    On Error GoTo EH
...
EH: If Err.Number <> 91 Then DisplayError Err, ModuleName & "GetEnabled", Control.Id
    Resume XT
End Function
Public Function GetVisible(ByVal Control As IRibbonControl, ByRef Visible)
    On Error GoTo EH
